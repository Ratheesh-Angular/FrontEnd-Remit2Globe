  ...
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-teal-600 to-teal-700">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-6 text-lg sm:text-xl text-teal-100 max-w-2xl mx-auto">
          Join thousands of customers who trust Amigo for fast, secure, and
          affordable international transfers.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/register"
            className="inline-flex items-center justify-center gap-2 h-14 px-8 text-base font-semibold text-teal-700 bg-white rounded-xl hover:bg-teal-50 transition-colors shadow-lg"
          >
            Get Started Free
