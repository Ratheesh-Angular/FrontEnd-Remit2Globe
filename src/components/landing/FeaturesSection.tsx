...
const FEATURES = [
  {
    ...
    title: "Fast Delivery",
    description:
      "Money arrives quickly — often within minutes to bank accounts and mobile wallets your recipients already use.",
  },
  {
    icon: Banknote,
    title: "Best Rates",
  ...
  },
  {
    ...
    description:
      "Send to bank accounts, mobile money wallets, or cash pickup locations. Flexible delivery for any recipient.",
  },
  {
    icon: Smartphone,
    title: "Easy Tracking",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {FEATURES.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="group bg-white rounded-2xl border border-slate-200 p-6 lg:p-8 hover:shadow-lg hover:shadow-slate-200/50 hover:border-teal-200 transition-all"
              >
