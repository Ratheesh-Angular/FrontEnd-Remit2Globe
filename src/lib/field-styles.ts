...
export const fieldControlBase =
  ...
  `focus:ring-2 focus:ring-red-500/20 focus:border-red-600 ` +
...
export const fieldDropdownOption =
  "flex items-center w-full px-3 min-h-10 text-sm text-left hover:bg-red-50 hover:text-red-700 transition-colors";
